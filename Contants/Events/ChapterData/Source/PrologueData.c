...
const struct ROMChapterData chapter_asset_prologue = {
    /* prologue */
    .internalName = NULL,
    .map = {
        .obj1Id = CHDATA_L3_ASSET1_OBJ,
        .obj2Id = 0,
        .paletteId = CHDATA_L3_ASSET1_PAL,
        .tileConfigId = CHDATA_L6_ASSET1_CONF,
        .mainLayerId = CHDATA_L2_MAP_Prologue,
    ...
    .mapEventDataId = CHDATA_L1_EVENT_Prologue,
    .gmapEventId = 1,
