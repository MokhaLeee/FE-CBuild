...
static DECL_INFO RText_Pow, RText_Mag, RText_Skl, RText_Spd, RText_Lck, RText_Def, RText_Res;
static DECL_INFO RText_Mov, RText_Con, RText_Aid, RText_Affin, RText_Trv, RText_Cond, RText_BAmt;
static DECL_INFO RText_Name, RText_Class, RText_Level, RText_Exp, RText_Hp;

DECL_INFO * const RTextPageUnit = &RText_Pow;
