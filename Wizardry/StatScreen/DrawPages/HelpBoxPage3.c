...
static DECL_INFO RText_Sword, RText_Lance, RText_Axe, RText_Bow, RText_Anima, RText_Light, RText_Dark, RText_Staff;
static DECL_INFO RText_Skill1, RText_Skill2, RText_Skill3, RText_Skill4, RText_Skill5, RText_Skill6, RText_Skill7, RText_Skill8;
static DECL_INFO RText_Name, RText_Class, RText_Level, RText_Exp, RText_Hp;
...
DECL_INFO * const RTextPageSkill = &RText_Sword;

static DECL_INFO RText_Sword = {
    NULL, &RText_Lance, &RText_Name, &RText_Skill1,
    0x66, 0x18, 0x546,
    NULL, NULL
};

static DECL_INFO RText_Lance = {
    &RText_Sword, &RText_Axe, &RText_Name, &RText_Skill2,
    0x66, 0x28, 0x547,
    NULL, NULL
};

static DECL_INFO RText_Axe = {
    &RText_Lance, &RText_Bow, &RText_Name, &RText_Skill3,
    0x66, 0x38, 0x548,
    NULL, NULL
};

static DECL_INFO RText_Bow = {
    &RText_Axe, &RText_Anima, &RText_Name, &RText_Skill4,
    0x66, 0x48, 0x549,
    NULL, NULL
};

static DECL_INFO RText_Anima = {
...
static DECL_INFO RText_Skill7 = {
    &RText_Skill6, &RText_Skill8, &RText_Dark, &RText_Level,
    0xA6, 0x78, 6,
    HbRedirect_Skill, HbPopuplate_Skill
};

static DECL_INFO RText_Skill8 = {
